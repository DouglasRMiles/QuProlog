...
'$query_symbols1526442635_617/0$0'/0:
...
$1:
	...
	deallocate
	proceed
end('$query_symbols1526442635_617/0$0'/0):



'$query_symbols1526442635_617'/0:
...
$1:
	allocate(0)
	call_predicate('$query_symbols1526442635_617/0$0', 0, 0)
	fail

$2:
	proceed
end('$query_symbols1526442635_617'/0):
...
$1:
	execute_predicate('$query_symbols1526442635_617', 0)
end('$query'/0):
